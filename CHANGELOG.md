...
- Add support for NUnit test projects running on the Microsoft Testing Platform (https://github.com/svenvanheugten/mutannot/issues/18)

### Fixed

- Fix `validate` silently ignoring `ShouldCatch` patches written as verbatim strings (`@"..."`) (https://github.com/svenvanheugten/mutannot/pull/53)
