...
To run your mutations, you use `dotnet tool run mutannot -- run [path/to/testproject.csproj|fsproj]`. It will do a control run of the original test cases, and then it will run the same tests again with the patches applied, to confirm that they now fail.
